...
The LaTeX source for this table is saved at
[`results/property_generation_table.tex`](results/property_generation_table.tex)
for direct inclusion in the paper.

The `results/` folder also contains the aggregated figures referenced in the
